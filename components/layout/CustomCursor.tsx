...
export function CustomCursor() {
    ...
    useEffect(() => {
        ...
        // Use GSAP's quickTo for high-performance interpolation without React state
        ...
        const onMouseEnterLink = (e: MouseEvent) => {
            ...
            // If it's a magnetic button (optional future implementation), we could snap the follower
            gsap.to(follower, {
                scale: 3,
                backgroundColor: "rgba(107, 142, 120, 0.4)", // Sage green tint
        ...
        // Re-attach on DOM mutations (for client-side routing/dynamic content)
